...
\newcommand{\paperversion}{Version 1.0.4}
...
The exact submission snapshot is designated \texttt{v1.0.4} and distributed
from \url{https://github.com/skypher/kraw/releases/tag/v1.0.4}.  The release
page records the corresponding Git commit.  The snapshot carries
...
include the source archive, manuscript PDF, hash records, and path-sanitized
profiled replay transcript.  Before publication, the exact accepted snapshot
...
\begin{center}
\small\nolinkurl{b8d918147e24d23461f492805c56ebbd4ab388f8ce2620514d4fb4fac7865c2f}
\end{center}
